...
var ErrorInterceptor = /** @class */ (function () {
    ...
    ErrorInterceptor.prototype.intercept = function (request, next) {
        ...
        return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            ...
            _this.name$ = _this.userService.name$.subscribe(function (aName) { return _this.name = aName; });
            var comp = _this.router.url.split('/')[1];
            var location = "";
            var errorDetails = "loggingLevel: " + (err.type ? err.type : "error") + " | userName: " + (_this.name ? _this.name : "-") + " | businessComponent: " + (comp ? comp : "App") + " | browser: " + _this.userService.getBrowserDetails() + " | location: " + (location !== "" ? "lat: " + location['lat'] + ", lng: " + location['lng'] : "") + " | message: " + (err.message ? err.message : "message not available") + " | exceptionStack: " + (err.stack ? err.stack : "stack not available");
            _this.userService.logError(JSON.stringify(errorDetails)).subscribe(function (res) { });
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_3__["appMode"].includes('DEBUG')) {
            this.user.logInfo(JSON.stringify("App Init")).subscribe(function (res) { });
        }
    };
...
/* harmony import */ var _services_error_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./services/error.service */ "./src/app/services/error.service.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [
                ...
                { provide: _angular_core__WEBPACK_IMPORTED_MODULE_2__["ErrorHandler"], useClass: _services_error_service__WEBPACK_IMPORTED_MODULE_22__["ErrorService"] }
            ],
...
var CardComponent = /** @class */ (function () {
    function CardComponent(productService, route, user) {
    ...
    CardComponent.prototype.ngOnInit = function () {
        var _this = this;
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_5__["appMode"].includes('DEBUG')) {
            this.user.logInfo("Card component init start").subscribe(function (res) { });
        }
        ...
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_5__["appMode"].includes('DEBUG')) {
            this.user.logInfo("Card component init End").subscribe(function (res) { });
        }
    };
    ...
    CardComponent.prototype.update = function () {
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_5__["appMode"].includes('DEBUG')) {
            this.user.logInfo("Card component update() start").subscribe(function (res) { });
        }
        ...
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_5__["appMode"].includes('DEBUG')) {
            this.user.logInfo("Card component update() end").subscribe(function (res) { });
        }
    };
    CardComponent.prototype.getProds = function (page, size) {
        ...
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_5__["appMode"].includes('DEBUG')) {
            this.user.logInfo("Card component getProds() start").subscribe(function (res) { });
        }
        if (this.route.snapshot.url.length == 1) {
            ...
            if (_environments_environment__WEBPACK_IMPORTED_MODULE_5__["appMode"].includes('INFO')) {
                this.user.logInfo("Page" + this.page).subscribe(function (res) { });
            }
        }
        else { //  /category/:id
            ...
            if (_environments_environment__WEBPACK_IMPORTED_MODULE_5__["appMode"].includes('INFO')) {
                this.user.logInfo("Category" + this.title).subscribe(function (res) { });
            }
        }
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_5__["appMode"].includes('DEBUG')) {
            this.user.logInfo("Card component getProds() end").subscribe(function (res) { });
        }
    };
...
var CartComponent = /** @class */ (function () {
    ...
    CartComponent.prototype.ngOnInit = function () {
        var _this = this;
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Cart component init start").subscribe(function (res) { });
        }
        ...
        }, function (_) { return _this.userService.logInfo("Update Item Failed").subscribe(function (res) { }); });
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Cart component init start").subscribe(function (res) { });
        }
    };
    CartComponent.prototype.ngOnDestroy = function () {
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Cart component ngOnDestroy start").subscribe(function (res) { });
        }
        if (!this.currentUser) {
        ...
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Cart component ngOnDestroy end").subscribe(function (res) { });
        }
    };
    CartComponent.prototype.ngAfterContentChecked = function () {
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Cart component ngAfterContentChecked start").subscribe(function (res) { });
        }
        this.total = this.productInOrders.reduce(function (prev, cur) { return prev + cur.count * cur.productPrice; }, 0);
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Cart component ngAfterContentChecked end").subscribe(function (res) { });
        }
    };
    CartComponent.prototype.addOne = function (productInOrder) {
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Cart component addOne() start").subscribe(function (res) { });
        }
        ...
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('INFO')) {
            this.userService.logInfo("Product in order added" + JSON.stringify(productInOrder)).subscribe(function (res) { });
        }
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Cart component addOne() end").subscribe(function (res) { });
        }
    };
    CartComponent.prototype.minusOne = function (productInOrder) {
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Cart component minusOne() start").subscribe(function (res) { });
        }
        productInOrder.count--;
        CartComponent_1.validateCount(productInOrder);
        if (this.currentUser) {
        ...
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('INFO')) {
            this.userService.logInfo("Product in order minus" + JSON.stringify(productInOrder)).subscribe(function (res) { });
        }
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Cart component minusOne() end").subscribe(function (res) { });
        }
    };
    CartComponent.prototype.onChange = function (productInOrder) {
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Cart component onChange() start").subscribe(function (res) { });
        }
        CartComponent_1.validateCount(productInOrder);
        if (this.currentUser) {
            this.updateTerms.next(productInOrder);
        ...
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Cart component onChange() end").subscribe(function (res) { });
        }
    };
    CartComponent.prototype.remove = function (productInOrder) {
        var _this = this;
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Cart component remove() start").subscribe(function (res) { });
        }
        ...
        }, function (_) { return _this.userService.logInfo("Remove Cart Failed").subscribe(function (res) { }); });
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('INFO')) {
            this.userService.logInfo("Product in order removed" + JSON.stringify(productInOrder)).subscribe(function (res) { });
        }
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Cart component remove() end").subscribe(function (res) { });
        }
    };
    CartComponent.prototype.checkout = function () {
        var _this = this;
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Cart component checkout() start").subscribe(function (res) { });
        }
        if (!this.currentUser) {
            ...
            this.cartService.checkout().subscribe(function (_) {
                ...
                _this.userService.logInfo("Checkout Cart Failed").subscribe(function (res) { });
            });
            this.router.navigate(['/']);
        }
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('INFO')) {
            this.userService.logInfo("Checkout " + JSON.stringify(this.productInOrders)).subscribe(function (res) { });
        }
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Cart component checkout() end").subscribe(function (res) { });
        }
    };
    var CartComponent_1;
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.ngOnInit = function () {
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_5__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Login component init start").subscribe(function (res) { });
        }
        var params = this.route.snapshot.queryParamMap;
        this.isLogout = params.has('logout');
        this.returnUrl = params.get('returnUrl');
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_5__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Login component init end").subscribe(function (res) { });
        }
    };
    LoginComponent.prototype.onSubmit = function () {
        var _this = this;
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_5__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Login component onSubmit() start").subscribe(function (res) { });
        }
        this.submitted = true;
        this.userService.login(this.model).subscribe(function (user) {
            if (user) {
                ...
                if (_environments_environment__WEBPACK_IMPORTED_MODULE_5__["appMode"].includes('INFO')) {
                    _this.userService.logInfo("USER Login: " + JSON.stringify(user)).subscribe(function (res) { });
                }
        ...
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_5__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Login component onSubmit() end").subscribe(function (res) { });
        }
    };
    LoginComponent.prototype.fillLoginFields = function (u, p) {
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_5__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Login component fillLoginFields() start").subscribe(function (res) { });
        }
        this.model.username = u;
        this.model.password = p;
        this.onSubmit();
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_5__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Login component fillLoginFields() end").subscribe(function (res) { });
        }
    };
...
var OrderDetailComponent = /** @class */ (function () {
    ...
    OrderDetailComponent.prototype.ngOnInit = function () {
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_4__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Order Details component init start").subscribe(function (res) { });
        }
        ...
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_4__["appMode"].includes('INFO')) {
            this.userService.logInfo("Order Details: " + JSON.stringify(this.order$)).subscribe(function (res) { });
        }
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_4__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Order Details component init end").subscribe(function (res) { });
        }
    };
...
var OrderComponent = /** @class */ (function () {
    ...
    OrderComponent.prototype.ngOnInit = function () {
        var _this = this;
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Order component init start").subscribe(function (res) { });
        }
        ...
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Order component init end").subscribe(function (res) { });
        }
    };
    OrderComponent.prototype.update = function () {
        var _this = this;
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Order component update() start").subscribe(function (res) { });
        }
        var nextPage = 1;
        var size = 10;
        if (this.route.snapshot.queryParamMap.get('page')) {
        ...
        this.orderService.getPage(nextPage, size).subscribe(function (page) { return _this.page = page; }, function (_) {
            _this.userService.logInfo("Get Orde Failed").subscribe(function (res) { });
        });
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('INFO')) {
            this.userService.logInfo("Order component Page: " + JSON.stringify(this.page)).subscribe(function (res) { });
        }
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Order component update() end").subscribe(function (res) { });
        }
    };
    OrderComponent.prototype.cancel = function (order) {
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Order component cancel() start").subscribe(function (res) { });
        }
        ...
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('INFO')) {
            this.userService.logInfo("Order component cancel order ID: " + order.orderId).subscribe(function (res) { });
        }
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Order component cancel() end").subscribe(function (res) { });
        }
    };
    OrderComponent.prototype.finish = function (order) {
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Order component finish() start").subscribe(function (res) { });
        }
        ...
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Order component finish() end").subscribe(function (res) { });
        }
    };
    OrderComponent.prototype.ngOnDestroy = function () {
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Order component ngOnDestroy() start").subscribe(function (res) { });
        }
        this.querySub.unsubscribe();
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Order component ngOnDestroy() end").subscribe(function (res) { });
        }
    };
...
var DetailComponent = /** @class */ (function () {
    function DetailComponent(productService, cartService, cookieService, route, router, userService) {
        this.productService = productService;
        this.cartService = cartService;
    ...
    DetailComponent.prototype.ngOnInit = function () {
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Product Details init start").subscribe(function (res) { });
        }
        this.getProduct();
        this.title = 'Product Detail';
        this.count = 1;
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Product Details init end").subscribe(function (res) { });
        }
    };
    ...
    DetailComponent.prototype.getProduct = function () {
        var _this = this;
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Product Details getProduct() start").subscribe(function (res) { });
        }
        ...
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('INFO')) {
            this.userService.logInfo("Product Details: " + JSON.stringify(this.productInfo)).subscribe(function (res) { });
        }
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Product Details getProduct() end").subscribe(function (res) { });
        }
    };
    DetailComponent.prototype.addToCart = function () {
        var _this = this;
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Product Details addToCart() start").subscribe(function (res) { });
        }
        this.cartService
        ...
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_8__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Product Details addToCart() end").subscribe(function (res) { });
        }
    };
...
var SignupComponent = /** @class */ (function () {
    function SignupComponent(location, userService, router) {
        ...
        this.userService = userService;
        this.router = router;
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_6__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Signup init start").subscribe(function (res) { });
        }
        this.user = new _models_User__WEBPACK_IMPORTED_MODULE_3__["User"]();
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_6__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Signup init end").subscribe(function (res) { });
        }
    }
    ...
    SignupComponent.prototype.onSubmit = function () {
        var _this = this;
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_6__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Signup onSubmit() start").subscribe(function (res) { });
        }
        this.userService.signUp(this.user).subscribe(function (u) {
            _this.router.navigate(['/login']);
        }, function (e) { });
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_6__["appMode"].includes('INFO')) {
            this.userService.logInfo("Signup user: " + JSON.stringify(this.user)).subscribe(function (res) { });
        }
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_6__["appMode"].includes('DEBUG')) {
            this.userService.logInfo("Signup onSubmit() end").subscribe(function (res) { });
        }
    };
...
var ErrorService = /** @class */ (function () {
    function ErrorService(injector, user) {
        this.injector = injector;
        this.user = user;
    }
    ErrorService.prototype.handleError = function (error) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var router, comp, location, e_1, errorDetails;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log(error);
                        router = this.injector.get(_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]);
                        this.name$ = this.user.name$.subscribe(function (aName) { return _this.name = aName; });
                        comp = router.url.split('/')[1];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.user.getPosition()];
                    case 2:
                        location = _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
                        ...
                        return [3 /*break*/, 4];
                    case 4:
                        errorDetails = "loggingLevel: " + (error.type ? error.type : "error") + " | userName: " + (this.name ? this.name : "-") + " | businessComponent: " + (comp ? comp : "App") + " | browser: " + this.user.getBrowserDetails() + " | location: " + (location !== "" ? "lat: " + location['lat'] + ", lng: " + location['lng'] : "") + " | message: " + (error.message ? error.message : "message not available") + " | exceptionStack: " + (error.stack ? error.stack : "stack not available");
                        this.user.logError(JSON.stringify(errorDetails)).subscribe(function (res) { });
                        return [2 /*return*/];
                }
            });
        });
    ...
    ErrorService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"], _user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"]])
    ], ErrorService);
    return ErrorService;
}());
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.logError = function (error) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["errURL"], error);
    };
    UserService.prototype.logWarning = function (warning) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["warnURL"], warning);
    };
    UserService.prototype.logInfo = function (info) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["infoURL"], info);
    };
    ...
    UserService.prototype.getBrowserDetails = function () {
...
/*!*****************************************!*\
  !*** ./src/environments/environment.ts ***!
  \*****************************************/
/*! exports provided: environment, apiUrl, appMode, errURL, warnURL, infoURL */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "errURL", function() { return errURL; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "warnURL", function() { return warnURL; });
...
var appMode = ['INFO', 'DEBUG'];
var errURL = 'http://10.0.0.20:31010/err';
var warnURL = 'http://10.0.0.20:31010/warn';
var infoURL = 'http://10.0.0.20:31010/info';
/*
...
module.exports = __webpack_require__(/*! C:\Users\IddpAdmin\Desktop\IDDP-ITC\Front-end\src\main.ts */"./src/main.ts");
